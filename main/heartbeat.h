...
*WebServer =           "192.168.8.19",                                   // ipaddress or name of the target server
...
enum Sensor sensorData = Led2;                      //The chosen sensor where the data is comming from. {Led2, aLed2, Led1, aLed1, diffLed2, diffLed1, AvgDiffLed2, AvgDiffLed1}
